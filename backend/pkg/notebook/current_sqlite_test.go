...
func TestOpenCurrentSQLiteModuleMountsCustomPaths(t *testing.T) {
	module, err := OpenCurrentSQLiteModule(CurrentSQLiteModuleConfig{
		AppDBPath:     filepath.Join(t.TempDir(), "app.sqlite"),
		RuntimeDBPath: filepath.Join(t.TempDir(), "runtime.sqlite"),
		BasePaths: BasePaths{
